namespace chat
{
    ...
    public partial class messageBox: Fuse.Controls.Rectangle
    {
        ...
        void InitializeUX()
        {
            ...
            var temp9 = new global::Fuse.Animations.Change<float4>(messageText_TextColor_inst);
            var temp10 = new global::Fuse.Reactive.DataBinding(temp_Value_inst, temp3, Fuse.Reactive.BindingMode.Read);
            var temp11 = new global::Fuse.Animations.Change<float4>(this_Color_inst);
            var temp12 = new global::Fuse.Animations.Change<float4>(messageText_TextColor_inst);
            var temp13 = new global::Fuse.Reactive.DataBinding(temp1_Value_inst, temp5, Fuse.Reactive.BindingMode.Read);
            var temp14 = new global::Fuse.Reactive.DataBinding(messageText_Value_inst, temp7, Fuse.Reactive.BindingMode.Read);
            ...
            temp8.Value = float4(0f, 0.6901961f, 1f, 1f);
            temp9.Value = float4(1f, 1f, 1f, 1f);
            temp1.Equals = "receiver";
            temp1.Animators.Add(temp11);
            temp1.Animators.Add(temp12);
            temp1.Bindings.Add(temp13);
            temp11.Value = float4(0.8f, 0.8f, 0.8f, 1f);
            temp12.Value = float4(0.1333333f, 0.1333333f, 0.1333333f, 1f);
            ...
            messageText.Bindings.Add(temp14);
